...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("E:\\01code\\git\\srsczx-admin\\src\\main\\java");//这里写你自己的java目录
        ...
        dsc.setUrl("jdbc:mysql://dev.ibdsr.cn:13306/srsczx");
        ...
        //设置生成的表
        strategy.setInclude(new String[]{"policy", "policy_content", "recruit"});
